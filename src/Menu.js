        ...
        <div class="flex relative  z-auto min-h-screen flex flex-col transition-all duration-200 overflow-hidden selection:bg-[#ff5a1d]">
            ...
            <main class="flex-1 ">
                ...
                {/* footer */}
                    ...
                    <div class="w-full h-auto relative border-box text-black font-bold bg-[#00f4cf] border-1 border-white md:border-none"   >
                                
                                <div class="flex flex-row min-w-full  justify-center items-center">
